...
def quickSort_endpivot(A,p,r):	
	start=time.time()
	if p<r :
		q=partition_endpivot(A,p,r)
		quickSort_endpivot(A,p,q-1)
		quickSort_endpivot(A,q+1,r)
	end=time.time()
	return (A,end-start)
...
qs_end=list()
qs_end,tq=quickSort_endpivot(QE,0,l-1) 
